...
class RNNSequenceNode : public ngraph::op::util::RNNCellBase {
public:
    static constexpr ngraph::NodeTypeInfo type_info{"RNNSequenceCPU", 0};
    const ngraph::NodeTypeInfo& get_type_info() const override { return type_info; }

    RNNSequenceNode(const ngraph::Output<ngraph::Node>& X,
